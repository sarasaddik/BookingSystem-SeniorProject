...
<footer class="footer">
  <div style={{backgroundColor: "#1273de"}}>
  <CDBBox
        display="flex"
 ...
 width="30px"
            />
            <span className="ms-4 h5 mb-0 font-weight-bold">Sara Booking</span>
          </a>
          <small className="ms-2">&copy; Sara Booking, 2023. All rights reserved.</small>
        </CDBBox>
        <CDBBox display="flex">
